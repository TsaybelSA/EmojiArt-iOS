...
extension View {
	func animatableFont(with size: CGFloat) -> some View {
...
//modifier which replaces uses of.toolbar
//in horizontally compact environments, it puts a single button in the toolbar
//with a context menu containing the items
